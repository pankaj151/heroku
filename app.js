...
const APIAI_ACCESS_TOKEN = process.env.APIAI_ACCESS_TOKEN || '97ff94b322a6428f8f1adb3a538f5276';
const APIAI_LANG = process.env.APIAI_LANG || 'en';
const FB_VERIFY_TOKEN = process.env.FB_VERIFY_TOKEN || 'geekofgeek';
const FB_PAGE_ACCESS_TOKEN = process.env.FB_PAGE_ACCESS_TOKEN || 'EAAC8HZB7QNZAQBAA3AGs6wODKZA0xKkC4yTHZBVKYnPHOOCjmwFnYLMNYupeQZBuuINbjBKPy9b7zuclIuhF85IuQ9poF8OkQoWRjprlKqoKU2f8YoPuJmFlktKcbZB7XzZAG8c94YthBMYKx5YTsoIxVptHeSJb9oMfnZCDL4G4jhjWIj2etOxm';
